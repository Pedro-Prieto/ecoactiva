...
function showPosition(position){
    document.getElementById('position_info').innerHTML = 'Consiguiendo la ubicación! Guardando tu publicación'
...
function  postionError(){
    document.getElementById('position_info').innerHTML = 'Encienda su GPS!!'
