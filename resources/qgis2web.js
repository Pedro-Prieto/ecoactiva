...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 5, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            extent: [-20037508.342789, -20037508.626929, 20037508.342789, 20037508.626929],
            units: 'm'})
    })
});
...
map.getView().fit([-20037508.342789, -20037508.626929, 20037508.342789, 20037508.626929], map.getSize());
